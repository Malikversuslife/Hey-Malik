...
export const workProjects: WorkProject[] = [
  { index: '01', name: 'PRIMA', slug: 'prima', cover: null, status: 'CASE STUDY LIVE', tags: [], featured: true, hasCaseStudy: true, category: 'AI / TRUST / PAYMENTS', summary: 'AI-assisted verification OS for decentralized payments.' },
